...
const Footer = () => {
  ...
  return (
    ...
    >
        ...
        <div className="space-y-[5vw]">
          ...
          <nav className="flex flex-wrap justify-center text-gray-700 text-lg font-medium">
            ...
            target='_blank'>Registration</Link>
              ...
              <Link href="https://nebulaaccelerator.org" target="_blank" className="hidden md:inline">
                About Nebula
              </Link>
            </div>
            ...
            <div className="w-full flex justify-center space-x-4 sm:space-x-6 md:hidden">
              ...
              <Link href="mailto:nebuladeftech@gmail.com" className="hidden md:inline">
                Contact Us
              </Link>
              <a href="tel:+919638413900" className="hidden md:inline ml-2 text-green-700 font-semibold">+91 9638413900</a>
              <Link href="https://nebulaaccelerator.org" target="_blank">About Nebula</Link>
            </div>
          </nav>
      ...
      <span className="mr-1"> <FaRegCopyright /></span> Digital India Hackathon. 2025 - All Rights Reserved 
</p>
